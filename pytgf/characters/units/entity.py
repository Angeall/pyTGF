"""
File containing the definition of an entity.
"""
...
class Entity:
    """
    A entity is something than can be placed on a tile of the game. It can be killed, drawn and moved.
    """

    def __init__(self, sprite: Optional[UnitSprite]=None, nb_lives: int=1, id_number: int=-1, speed: int=150):
        """
        Instantiates an entity unit in the game

        Args:
            sprite: The sprite to draw on the board (can be None if the entity must not be drawn)
            nb_lives: The number of lives this unit has before it dies
            id_number: The number representing the player that owns this entity
        """
    ...
    def setNbLives(self, nb_lives: int) -> None:
        """
        Sets the given number of lives of the entity

        Args:
            nb_lives: The number of lives to set to the entity
        """
        self._nbLives = nb_lives
        if self._nbLives <= 0:
            self._isAlive = False
    ...
    def draw(self, surface: pygame.Surface) -> None:
        ...
        Args:
            surface: The surface the entity will be drawn on
        """

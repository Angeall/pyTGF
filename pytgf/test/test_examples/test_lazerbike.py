...
from pytgf.examples.lazerbike.control.linker import GO_RIGHT, GO_UP, GO_DOWN, LazerBikeBotLinker
...
class TestLazerbike(unittest.TestCase):
    ...
    def test_copy(self):
        self.loop.addUnit(Bike(200, 1, max_trace=-1), LazerBikeBotLinker(Passive(1)), (15, 25), GO_DOWN, team=1)
        self.loop.addUnit(Bike(200, 2, max_trace=-1), LazerBikeBotLinker(Passive(2)), (30, 25), GO_UP, team=2)
        start = time.time()
    ...
    def test_draw_4_players(self):
        self.loop.addUnit(Bike(200, 1, max_trace=-1), LazerBikeBotLinker(Passive(1)), (15, 25), GO_DOWN, team=1)
        self.loop.addUnit(Bike(200, 2, max_trace=-1), LazerBikeBotLinker(Passive(2)), (30, 25), GO_UP, team=2)
        self.loop.addUnit(Bike(200, 3, max_trace=-1), LazerBikeBotLinker(Passive(3)), (15, 50), GO_DOWN, team=3)
        self.loop.addUnit(Bike(200, 4, max_trace=-1), LazerBikeBotLinker(Passive(4)), (30, 50), GO_UP, team=4)
        self.assertEqual(len(self.loop.run()), 0)

    def test_p1_win(self):
        self.loop.addUnit(Bike(100, 1, max_trace=-1), LazerBikeBotLinker(Passive(1)), (15, 0), GO_RIGHT, team=1)
        self.loop.addUnit(Bike(200, 2, max_trace=-1), LazerBikeBotLinker(Passive(2)), (30, 0), GO_UP, team=2)
        self.assertEqual(self.loop.run()[0].playerNumber, 1)

    def test_p2_win(self):
        self.loop.addUnit(Bike(200, 1, max_trace=-1), LazerBikeBotLinker(Passive(1)), (15, 0), GO_DOWN, team=1)
        self.loop.addUnit(Bike(100, 2, max_trace=-1), LazerBikeBotLinker(Passive(2)), (30, 0), GO_RIGHT, team=2)
        self.assertEqual(self.loop.run()[0].playerNumber, 2)

    def test_p3_win(self):
        self.loop.addUnit(Bike(200, 1, max_trace=-1), LazerBikeBotLinker(Passive(1)), (15, 25), GO_DOWN, team=1)
        self.loop.addUnit(Bike(200, 2, max_trace=-1), LazerBikeBotLinker(Passive(2)), (30, 25), GO_UP, team=2)
        self.loop.addUnit(Bike(200, 3, max_trace=-1), LazerBikeBotLinker(Passive(3)), (30, 35), GO_UP, team=3)
        self.assertEqual(self.loop.run()[0].playerNumber, 3)

    def test_team1_win(self):
        self.loop.addUnit(Bike(200, 1, max_trace=-1), LazerBikeBotLinker(Passive(1)), (15, 25), GO_DOWN, team=1)
        self.loop.addUnit(Bike(200, 2, max_trace=-1), LazerBikeBotLinker(Passive(2)), (30, 25), GO_UP, team=2)
        self.loop.addUnit(Bike(200, 3, max_trace=-1), LazerBikeBotLinker(Passive(3)), (30, 35), GO_UP, team=1)

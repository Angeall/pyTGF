...
def dist(a: Coordinates, b: Coordinates):
    """
...
def vectorize(p1: Coordinates, p2: Coordinates, signed: bool=True) -> Coordinates:
    """
...
def get_convex_hull(points: List[Coordinates]) -> ConvexHull:
    """
...
def get_path(points: List[Coordinates], convex_hull: ConvexHull) -> Path:
    """

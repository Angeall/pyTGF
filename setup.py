...
setup(
    ...
    packages=['pytgf', 'pytgf.game', 'pytgf.menu', 'pytgf.test', 'pytgf.test.test_board', 'pytgf.test.test_controls',
              ...
              'pytgf.examples.lazerbike.res.AIs', 'pytgf.examples.lazerbike.rules', 'pytgf.examples.lazerbike.units',
              'pytgf.examples.lazerbike.control', 'pytgf.characters', 'pytgf.characters.ai', 'pytgf.characters.moves',
              'pytgf.characters.units'],

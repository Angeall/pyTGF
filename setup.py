...
setup(
    name='pyTGF',
    version='',
    packages=['pytgf', 'pytgf.ai', 'pytgf.ai.deeplearn', 'pytgf.data', 'pytgf.game', 'pytgf.menu', 'pytgf.test',
              'pytgf.test.test_data', 'pytgf.test.test_board', 'pytgf.test.test_controls',
